...
Version  : 4.6.2
Release  : 16
URL      : https://github.com/Ultimaker/libArcus/archive/4.6.2/libArcus-4.6.2.tar.gz
Source0  : https://github.com/Ultimaker/libArcus/archive/4.6.2/libArcus-4.6.2.tar.gz
...
%prep
%setup -q -n libArcus-4.6.2
cd %{_builddir}/libArcus-4.6.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594748507
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libArcus-4.6.2/LICENSE %{buildroot}/usr/share/package-licenses/libArcus/2fa84abcb9ebd82e02a9ba263551d24b04e8c691
cp %{_builddir}/libArcus-4.6.2/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libArcus/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
