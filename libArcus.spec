...
%prep
%setup -q -n libArcus-4.5.0
cd %{_builddir}/libArcus-4.5.0
%patch1 -p1
...
cp %{_builddir}/libArcus-4.5.0/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libArcus/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
