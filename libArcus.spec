...
Version  : 4.7.0
Release  : 17
URL      : https://github.com/Ultimaker/libArcus/archive/4.7.0/libArcus-4.7.0.tar.gz
Source0  : https://github.com/Ultimaker/libArcus/archive/4.7.0/libArcus-4.7.0.tar.gz
...
%prep
%setup -q -n libArcus-4.7.0
cd %{_builddir}/libArcus-4.7.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598468084
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libArcus-4.7.0/LICENSE %{buildroot}/usr/share/package-licenses/libArcus/2fa84abcb9ebd82e02a9ba263551d24b04e8c691
cp %{_builddir}/libArcus-4.7.0/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libArcus/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
